![Pixelstar](https://github.com/GokuSan2/pixel-manifest/raw/14-qpr3/Banner.png)
...
```bash
git lfs install && repo init -u https://github.com/GokuSan2/pixel-manifest -b 14-qpr3 --git-lfs && repo sync -c -j$(nproc --all) --force-sync --no-clone-bundle --no-tags
```
### Build ###
